...
const defaultWelcomeMessage =
  'Hola! Soy tú AI-Taecher y estoy aquí para ayudarte a mejorar tu aprendizaje en materias como "Lenguaje y Literatura" "Matematicas" "Ciencias Naturales" "Historia, Geografia y Ciencias Sociales" "Ingles" ';
